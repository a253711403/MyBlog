package cn.akeem.mapper;

import cn.akeem.model.Role;
...
public interface UserMapper {
    ...
    @Results({
            ...
            @Result(column = "phone", property = "roles", javaType = List.class, many = @Many(select = "UserMapper.getRoleNameByPhone")),
    })
